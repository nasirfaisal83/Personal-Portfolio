...
export const scene: Scene = {
  ...
  narrow: {
    ...
    nodes: [
      ...
      { id: "question", label: "question", x: 12, y: 428, w: 150, h: 34, kind: "client" },
      { id: "qembed", label: "embed", x: 190, y: 428, w: 150, h: 34, kind: "stage" },
      { id: "prompt", label: "prompt", x: 12, y: 486, w: 150, h: 34, kind: "stage" },
      { id: "answer", label: "answer", x: 190, y: 486, w: 150, h: 34, kind: "agent" },
    ],
  },
};
